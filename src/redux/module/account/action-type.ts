export enum ActionType {
  SET_CURRENT_ACCOUNT_ADDRESS = 'dappface/account/SET_CURRENT_ACCOUNT_ADDRESS',
  SET_DEFAULT_ACCOUNT_ADDRESS = 'dappface/account/SET_DEFAULT_ACCOUNT_ADDRESS',
  SET_FIAT_RATE = 'dappface/account/SET_FIAT_RATE',
